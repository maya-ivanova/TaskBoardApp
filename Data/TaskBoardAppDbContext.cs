...
namespace TaskBoardApp.Data
{
    public class TaskBoardAppDbContext : IdentityDbContext<User>
    {
        ...
        {
            builder.Entity<TaskBoardApp.Data.Entities.Task>().HasOne(t => t.Board).WithMany(b => b.Tasks).HasForeignKey(t => t.BoardId).OnDelete(DeleteBehavior.Restrict);
            ...
            builder.Entity<TaskBoardApp.Data.Entities.Task>().HasData(new TaskBoardApp.Data.Entities.Task()
            {
                Id = 1,
